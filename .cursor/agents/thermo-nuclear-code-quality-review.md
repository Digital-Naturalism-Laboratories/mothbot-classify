...
1. Load the `thermo-nuclear-code-quality-review` skill (`.agents/skills/thermo-nuclear-code-quality-review/SKILL.md` in the workspace) and treat its `SKILL.md` as the **complete** rubric — tone, approval bar, output ordering, code-judo / 1k-line / spaghetti rules.
