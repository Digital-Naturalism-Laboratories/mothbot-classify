...
describe('morpho covers legacy leafGroupId normalization', () => {
  beforeEach(() => {
    vi.clearAllMocks()
    morphoCoversStore.set({})
  })

  it('normalizes legacy leafGroupId values on load', async () => {
  ...
  it('normalizes leafGroupId before persisting overrides', async () => {
